...
spreaders <- rename(spreaders,"month lag between bird at ori and virus mig"=lag)
spreaders <- rename(spreaders,"correlation between bird at ori and virus mig"=corr)
