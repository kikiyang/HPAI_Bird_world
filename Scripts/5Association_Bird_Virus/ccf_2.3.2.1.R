...
od_month_migtimes <- read.csv('/Users/qiqiy/Documents/P2_WAI/manuscript/HPAI_Bird_world/Scripts/4Markov_jump/virus_od_month_migtimes_bf3_2.3.2.1.csv')
...
birds <- read.csv('/Users/qiqiy/Documents/P2_WAI/manuscript/HPAI_Bird_world/Scripts/3Bird_month_dist/Location_Bird_Prob/output/2.3.2.1_bird.csv')
...
write.csv(ori.df %>% filter(p<0.05/9),'ori.df.multiCom_2.3.2.1.csv')
write.csv(dest.df %>% filter(p<0.05/9),'dest.df.multiCom_2.3.2.1.csv')
